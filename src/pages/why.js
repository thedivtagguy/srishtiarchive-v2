...
<section class="px-2 lg:py-20 h-full lg:mx-40 ">
    <div class="flex flex-row justify-start items-center">
        ...
        <div class="flex flex-col items-center col-span-12 w-full overflow-hidden border-1 border-accent-gray shadow-sm rounded-xl md:col-span-6 lg:col-span-4">
                    ...
                    <div class="relative flex flex-col items-start px-6  py-4 bg-accent-gray hover:bg-yellow-700 transition duration-150 ease-in-out py-7">
                        ...
                        <h2 class="font-bold tracking-wide text-left lg:text-2xl text-sm  text-light-gray"><a href="https://submit.srishtiarchive.com">Submit your Project</a></h2>
                        <p class="mt-2 text-sm text-gray-500">Help preserve work for future students. Free good karma, eh?</p>
                    </div>
                    </a>
                </div>
