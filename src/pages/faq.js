...
<section class="relative min-w-screen animation-fade animation-delay">
    <div class="container px-8 mx-auto sm:px-12 xl:px-5">
        ...
        <div class="w-full px-6 py-6 mx-auto mt-10 bg-accent-gray  highlight-border rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
            <h3 class="text-lg font-bold text-high-yellow sm:text-xl md:text-2xl">Who owns my work?</h3>
            <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
                You do! There is no change in ownership, but your work will be shared under a CC-BY-NC-SA license, which allows people to build on it.
            </p>
        </div>
        <div class="w-full px-6 py-6 mx-auto mt-10 bg-accent-gray  highlight-border rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
            <h3 class="text-lg font-bold text-high-yellow sm:text-xl md:text-2xl">What are the terms of the CC-BY-NC-SA license?</h3>
            <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
        ...
        <div class="w-full px-6 py-6 mx-auto mt-10 bg-accent-gray  highlight-border rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
            <h3 class="text-lg font-bold text-high-yellow sm:text-xl md:text-2xl">What about plagiarism?</h3>
            <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
        ...
        <div class="w-full px-6 py-6 mx-auto mt-10 bg-accent-gray  highlight-border rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
            <h3 class="text-lg font-bold text-high-yellow sm:text-xl md:text-2xl">Can I update or remove my work later?</h3>
            <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
        ...
        <div class="w-full px-6 py-6 mx-auto mt-10 bg-accent-gray  highlight-border rounded-lg sm:px-8 md:px-12 sm:py-8 sm:shadow lg:w-5/6 xl:w-2/3">
            <h3 class="text-lg font-bold text-high-yellow sm:text-xl md:text-2xl">Melody itni choclatey kyun hai?</h3>
            <p class="mt-2 text-base text-gray-600 sm:text-lg md:text-normal">
