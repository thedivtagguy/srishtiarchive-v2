...
<SiteMetadata title="FAQ" description="I have concerns..." />
    <section class="relative min-w-screen animation-fade animation-delay">
        <div class="container flex flex-col justify-center items-center px-8 mx-auto sm:px-12 xl:px-5">      
            ...
            <div class="w-full px-6 py-6 mx-auto mt-4 rounded-lg sm:px-8 md:px-12 sm:py-8  lg:w-5/6 xl:w-2/3">
            <a href="#featured"><h3 id="featured" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl  hover:underline">What are Featured Projects?</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
            ...
            <a href="#not-good-enough"><h3 id="not-good-enough" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl  hover:underline">I don't think I did anything good enough...</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
            ...
            <div class="w-full px-6 py-6 mx-auto mt-10  rounded-lg sm:px-8 md:px-12 sm:py-8  lg:w-5/6 xl:w-2/3">
            <a href="#overthink"> <h3 id="overthink" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl hover:underline">Do I need to rework/revamp/redo/re-assemble/rethink my project?</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
            ...
            <div class="w-full px-6 py-6 mx-auto mt-10  rounded-lg sm:px-8 md:px-12 sm:py-8  lg:w-5/6 xl:w-2/3">
            <a href="#ownership"><h3 id="ownership" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl hover:underline">Who owns my work?</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
            ...
            <div class="w-full px-6 py-6 mx-auto mt-10  rounded-lg sm:px-8 md:px-12 sm:py-8  lg:w-5/6 xl:w-2/3">
            <a href="#terms"> <h3 id="terms" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl hover:underline">What are the terms of the CC-BY-NC-SA license?</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
            ...
            <div class="w-full px-6 py-6 mx-auto mt-10  rounded-lg sm:px-8 md:px-12 sm:py-8  lg:w-5/6 xl:w-2/3">
            <a href="#plagiarism"> <h3 id="plagiarism" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl hover:underline">What about plagiarism?</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
            ...
            <div class="w-full px-6 py-6 mx-auto mt-10  rounded-lg sm:px-8 md:px-12 sm:py-8  lg:w-5/6 xl:w-2/3">
            <a href="#update">  <h3 id="update" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl hover:underline">Can I update or remove my work later?</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
            ...
            <div class="w-full px-6 py-6 mx-auto mt-10  rounded-lg sm:px-8 md:px-12 sm:py-8  lg:w-5/6 xl:w-2/3">
            <a href="#melody">   <h3 id="melody" class="text-lg font-bold text-gray-800 sm:text-xl md:text-2xl hover:underline">Melody itni chocolatey kyun hai?</h3></a>
                <p class="mt-2 text-base text-black sm:text-lg md:text-normal">
