...
export default props => {
  ...
  return (
    <Layout>
      ...
      <div className="bg-transparent flex mx-auto h-1/2 lg:py-8 max-w-5xl">
      
        <div className="flex flex-col justify-center items-center">
         <img class="object-cover w-4/5 rounded-tl-xl rounded-tr-xl h-64" src="https://cdn.devdojo.com/images/may2021/snacks.jpg"/>
                   
          <div className="flex flex-col justify-center items-center">
            <div className="w-full flex flex-col justify-start items-start  lg:w-4/5 pb-8">
...
export const query = graphql`
  query Portfolio {
    item: contentfulPortfolio(slug: { eq: "spine-is-fine-2419" }) {
        description {
          description
        }
        major
