  ...
  return (
    ...
    <div class="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8 px-4 py-4 text-center grid-cols-2">
      ...
      <div>
        ...
        <p class="pt-4 text-xs lg:text-xs text-center">Designed and &lt;/&gt; by <a href="https://instagram.com/thedivtagguy"  rel="noreferrer" target="_blank"><span class="hover:text-purple-700 hover:underline font-semibold">Aman Bhargava</span></a></p>

      </div>
    </div>
    <p class="pt-4 mx-auto text-mxs lg:text-xs text-center lg:w-1/4"> By using the Archive, students agree to adhere to <a href="http://srishtimanipalinstitute.in/policies/srishti-policy-on-ethical-conduct-and-practice"  rel="noreferrer" target="_blank" class=" font-bold">Srishti Manipal Institute of Art, Design and Technology's Policy on Ethical Conduct and Practice</a></p>
    <p class="pt-4 mx-auto text-mxs lg:text-mxs text-center">With 99.99% better uptime than any other Srishti portal <span role="img" aria-label="Peace Sign">✌️</span></p>
