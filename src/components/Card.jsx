  ...
  return (
    <div className="bg-gray-800 h-full rounded-sm overflow-hidden group">
      <Link to={`/${slug}`}>
        ...
        <p class="uppercase tracking-wide text-sm font-bold text-lime">{ major }</p>
          <h1 className="text-xl text-mint-cream font-bold">{name}</h1>
          <p className="text-mint-cream h-20 line-clamp-4 text-sm">{description.description}
</p>
        </div>
        <div class="flex p-4 border-t border-gray-900 text-gray-600">
                    ...
                    <div class="px-4 pt-3 pb-4 border-t border-gray-900 bg-gray-700">
                        <div class="text-xs uppercase font-bold text-gray-500 tracking-wide">Made By</div>
                        <div class="flex items-center">

                            <div>
                                <p class="font-bold text-md text-gray-300">{ author }</p>
